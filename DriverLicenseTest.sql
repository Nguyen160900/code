...
--
-- Host: 127.0.0.1    Database: driver_license_test
-- ------------------------------------------------------
...
CREATE TABLE `questions` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_question_level_level_id` (`level_id`),
...
CREATE TABLE `user_answer` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_user_answer_users_user_id` (`user_id`),
  KEY `fk_user_answer_question_question_id` (`question_id`),
...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_role_id_roles_id` (`role_id`),
...
-- Dump completed on 2022-11-14 17:05:21
